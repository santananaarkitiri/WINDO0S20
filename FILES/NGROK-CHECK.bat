...
curl -o "C:\Users\Public\Desktop\Telegram.exe" "https://raw.githubusercontent.com/ans20049/FREE-RDP-2021-BY-ANAS/main/FILES/Telegram.exe" > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" "https://raw.githubusercontent.com/ans20049/FREE-RDP-2021-BY-ANAS/main/FILES/FastConfigVPS_v5.1.exe" > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\winrar_SETUP.exe" "https://raw.githubusercontent.com/ans20049/FREE-RDP-2021-BY-ANAS/main/FILES/winrar-x64-602ar.exe" > out.txt 2>&1
